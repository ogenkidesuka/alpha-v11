exports.private = () =>{
	return`di pm bisa nya :v`
	}
exports.wait = () => {
    return `sabar tod proses dlu`
}
exports.ok = () => {
    return `done tod`
}
...
exports.err = () => {
    return `lagi error anj fiturnya`
}
exports.erorLink = () => {
    return `error tod link nya`
}
exports.media = () => {
    return `pilih media yang kamu mau download tod`
}
...
exports.ownerOnly = () => {
    return `huuuu cuma buat owner doang :v`
}
...
exports.groupOnly = () => {
    return `👥  bisa nya cuma di grup`
}

exports.adminOnly = () => {
    return `cuma bisa buat admin doang!`
}
...
exports.botNotAdmin = () => {
    return `meh bot adminin dlu`
}

exports.received = (pushname) => {
    return `
Halo ${pushname}!
makaseh tod, laporanmu akan kami segera terima.`
}

exports.videoLimit = () => {
    return `kegedean anj :v`
}
...
saya ${botname}, bot Beta Multi-Device Whatsapp.
`
}
